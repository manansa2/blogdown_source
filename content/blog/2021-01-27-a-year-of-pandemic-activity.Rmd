...
Of course, much of this blog post is anecdotal. I can’t be entirely certain a change in my resting HR can be directly attributed to one thing or if my heart rate even really increased at all <i>(read “Causal Inference” by Miguel A. Hernán, James M. Robins</i>). I haven’t very good at recalibrating my watch so again, not sure if these numbers are 100% accurate. Additionally, there may be discrepancies in some of the data collected, because I have used other apps such as Strava, Nike Run, Peloton, which probably collect data differently.

But one thing I am certain of is that I will not be making big health related decisions based on what my watch tells me. My wrist will just feel funny if I don't have it on.
